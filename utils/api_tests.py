...
class APIRequests:
    ...
    def get_test(url, status_code, json_schema):
        ...
        Checking.check_status_code(get_result, status_code)
    ...
    def post_test(url, body, status_code, json_schema):
        ...
        Checking.check_status_code(post_result, status_code)
    ...
    def put_test(url, json, status_code, json_schema):
        ...
        Checking.check_status_code(put_result, status_code)
    ...
    def patch_test(url, json, status_code, json_schema):
        ...
        Checking.check_status_code(patch_result, status_code)
    ...
    def delete_test(url, status_code, json_schema):
        ...
        Checking.check_status_code(delete_result, status_code)
